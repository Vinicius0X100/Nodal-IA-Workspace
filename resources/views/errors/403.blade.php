...
<head>
    ...
    <title>Acesso Negado — Nodal</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        body { font-family: 'Inter', ui-sans-serif, system-ui, sans-serif; min-height: 100vh; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #0a0f1e 0%, #0d1530 40%, #0a1628 70%, #060d1a 100%); color: #fff; -webkit-font-smoothing: antialiased; overflow: hidden; position: relative; }
        ...
        .glow-1 { position: absolute; top: 25%; left: 25%; width: 400px; height: 400px; background: radial-gradient(circle, rgba(245,158,11,0.12), transparent); border-radius: 50%; filter: blur(60px); pointer-events: none; }
        .glow-2 { position: absolute; bottom: 25%; right: 25%; width: 300px; height: 300px; background: radial-gradient(circle, rgba(217,119,6,0.08), transparent); border-radius: 50%; filter: blur(60px); pointer-events: none; }
        ...
        .error-icon-inner { padding: 16px; border-radius: 16px; background: rgba(255,255,255,0.06); backdrop-filter: blur(16px); border: 1px solid rgba(255,255,255,0.12); box-shadow: 0 8px 32px rgba(245,158,11,0.2), inset 0 1px 0 rgba(255,255,255,0.1); }
        .error-icon-inner svg { width: 32px; height: 32px; color: #FCD34D; }
        ...
        .status-dot { width: 6px; height: 6px; border-radius: 50%; background: #F59E0B; box-shadow: 0 0 6px #F59E0B; }
...
<body>
    ...
    <div class="content">
        ...
        <h1>Acesso negado</h1>
        <p>Você não possui permissão para acessar este recurso. Contate o administrador da sua organização.</p>
        <div class="actions">
        ...
        <div class="status-badge"><span class="status-dot"></span>HTTP 403</div>
