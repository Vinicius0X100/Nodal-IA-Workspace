...
<head>
    ...
    <title>Ação Necessária: Documentos aprovados</title>
    <style>
                ...
                <tr>
                    <td style="background-color:#ffffff; padding: 32px 32px 8px; border-radius: 0;">
                        ...
                        <p style="margin:0 0 24px; font-size:15px; color:#3c4043; font-family:'Inter',Arial,sans-serif; line-height:1.6;">
                            Temos ótimas notícias! Avaliamos os documentos enviados e <strong>sua empresa foi verificada com sucesso</strong> em nossa plataforma.
                        </p>
                    </td>
                </tr>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #dadce0; border-radius:8px; overflow:hidden;">
                            <tr>
                                <td width="64" style="vertical-align:top; padding:20px 0 20px 20px;">
                                    <div style="width:40px; height:40px; background-color:#e6f4ea; border-radius:50%; display:table-cell; text-align:center; vertical-align:middle;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#137333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle; margin-top: 8px;">
                                ...
                                <td style="padding:20px 20px 20px 12px; vertical-align:top;">
                                    <p style="margin:0 0 6px; font-size:14px; color:#3c4043; font-family:'Inter',Arial,sans-serif;">
                                        Status da verificação: <span style="color:#137333; font-weight:600;">Aprovada</span>
                                    </p>
                                    <p style="margin:0 0 16px; font-size:14px; color:#3c4043; font-family:'Inter',Arial,sans-serif; line-height:1.5;">
                                        Sua conta agora tem o selo de verificação Nodal. Todos os recursos e limites expandidos já estão ativados.
                                    </p>
                                    <a href="{{ config('app.url') }}/dashboard"
                                       style="display:inline-block; background-color:#34a853; color:#ffffff; text-decoration:none; font-family:'Inter',Arial,sans-serif; font-size:14px; font-weight:500; padding:10px 22px; border-radius:4px;">
                                        Acessar o Painel
                                    </a>
                                </td>
                            </tr>
