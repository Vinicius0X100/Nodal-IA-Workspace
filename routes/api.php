...
Route::prefix('ai')->middleware('ai.gateway')->group(function () {
    ...
    Route::post('/resources/spreadsheets', [\App\Domain\AI\Api\Controllers\AIResourcesController::class, 'createSpreadsheet']);
    Route::post('/spreadsheets/{uuid}/values', [\App\Domain\AI\Api\Controllers\AIResourcesController::class, 'updateSpreadsheetValues'])->whereUuid('uuid');
    Route::post('/spreadsheets/{uuid}/format', [\App\Domain\AI\Api\Controllers\AIResourcesController::class, 'formatSpreadsheet'])->whereUuid('uuid');
    Route::post('/resources/upload-attachment', [\App\Domain\AI\Api\Controllers\AIResourcesController::class, 'uploadAttachment']);
    ...
    Route::get('/meta/actions/pending', [\App\Domain\AI\Api\Controllers\AIMetaActionsController::class, 'getPendingAction']);
